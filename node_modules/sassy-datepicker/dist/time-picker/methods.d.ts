 ...
 */
export declare const alignTime: ({ hours, minutes }: Time, interval: number, lower?: boolean) => Time;
/**
 * Convert Time to a 12hr TimeDisplay format
 *
 * @param selectedTime
 */
export declare const timeToTimeDisplay: (selectedTime: Time) => TimeDisplay;
export declare const generateHourOptions: (timeFormat: DisplayFormat) => OptionType<number>[];
export declare const generateMinuteOptions: (minutesInterval: number) => OptionType<number>[];
/**
 ...
 */
export declare const convertHourFrom12HrTo24Hr: (hour: number, meridiem: Meridiem) => number;
